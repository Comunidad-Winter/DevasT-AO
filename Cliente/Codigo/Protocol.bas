...
'***************************************************
    ...
    frmMain.StaBar = UserMinSTA & "/" & UserMaxSTA
End Sub
...
'***************************************************
    ...
    End If
    frmMain.ManaBar = UserMinMAN & "/" & UserMaxMAN
End Sub
...
'***************************************************
    ...
    Else
        UserEstado = 0
    End If
    frmMain.HpBar = UserMinHP & "/" & UserMaxHP
End Sub
...
'***************************************************
    ...
    frmMain.AguBar = UserMinAGU & "/" & UserMaxAGU
    frmMain.HamBar = UserMinHAM & "/" & UserMaxHAM
End Sub
